                ...
                <div className="w-full md:w-[340px] lg:w-[380px] border border-gray-200 rounded-2xl p-6 sm:p-8 md:p-10 bg-white flex flex-col items-center shadow-sm">
                    ...
                    <div className="relative mb-4">
                        <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-sm">
                            {/* Assuming owner.png exists from earlier steps. Fallback to generic image. */}
                            <img src={ownerImg} alt="Profile" className="w-full h-full object-cover" />
                        </div>
                        <button className="absolute bottom-1 right-1 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md border border-gray-100 text-gray-500 hover:text-gray-900 transition-colors">
